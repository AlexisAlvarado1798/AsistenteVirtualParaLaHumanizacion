 ...
 */
@Entity
@Table(name = "ACCIONPERMITIDAPLANTILLA", catalog = "", schema = "ADMINAV")
@XmlRootElement
@NamedQueries({
...
public class Accionpermitidaplantilla implements Serializable {
    ...
    public String toString() {
        return "asistentevirtual.jpa.entidades.Accionpermitidaplantilla[ pkAccionpermitidaplantilla=" + pkAccionpermitidaplantilla + " ]";
    }
