...
import asistentevirtual.ejb.fachadas.TipoidentificacionFacade;
...
public class TipoidentificacionController implements Serializable {
    ...
    private Tipoidentificacion current;
    private DataModel items = null;
    @EJB
    private asistentevirtual.ejb.fachadas.TipoidentificacionFacade ejbFacade;
    ...
    public Tipoidentificacion getSelected() {
        if (current == null) {
            current = new Tipoidentificacion();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (Tipoidentificacion) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TipoidentificacionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TipoidentificacionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TipoidentificacionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Tipoidentificacion getTipoidentificacion(java.math.BigDecimal id) {
    ...
    public static class TipoidentificacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tipoidentificacion) {
                ...
                return getStringKey(o.getPkTipoidentificacion());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Tipoidentificacion.class.getName());
            }
        }
