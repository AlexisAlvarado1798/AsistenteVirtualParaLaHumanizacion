...
import asistentevirtual.ejb.fachadas.TelefonoFacade;
...
public class TelefonoController implements Serializable {
    ...
    private Telefono current;
    private DataModel items = null;
    @EJB
    private asistentevirtual.ejb.fachadas.TelefonoFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Telefono) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TelefonoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TelefonoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("TelefonoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Telefono getTelefono(java.math.BigDecimal id) {
    ...
    public static class TelefonoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Telefono) {
                ...
                return getStringKey(o.getPkTelefono());
            } else {
