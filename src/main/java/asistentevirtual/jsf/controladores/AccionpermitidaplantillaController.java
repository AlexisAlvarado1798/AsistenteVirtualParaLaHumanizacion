...
import asistentevirtual.jpa.entidades.Accionpermitidaplantilla;
import asistentevirtual.jsf.controladores.util.JsfUtil;
import asistentevirtual.jsf.controladores.util.PaginationHelper;
import asistentevirtual.ejb.fachadas.AccionpermitidaplantillaFacade;
...
public class AccionpermitidaplantillaController implements Serializable {
    ...
    @EJB
    private asistentevirtual.ejb.fachadas.AccionpermitidaplantillaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("AccionpermitidaplantillaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("AccionpermitidaplantillaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("AccionpermitidaplantillaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
